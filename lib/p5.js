...
;(function(exports) {
	...
	exports.brighon(c1, c2, amt) {
	    var c = [];
	    for (vxports.fill = function() {
		    var c = PHelper.getNo=> [g, g, g, a]
		    *                 r, g, b      ==> [r, g, b, 255]
		    *                 r, g, b, a   ==> [r, g, b, a]
		    *                 [g]          ==> [g, g, g, 255]
		    *                 [g, a]       ==> [g, g, g, a]
  ...
  */
			...
			if (_args.length >= 3) {
			    ...
			    g = _args[1];
			    b = _args[2];
      a = typeof _args[3] === 'numbe/255.0) : 1;
...
;(function(exports) {
  ...
  function doNf() {
    ...
    if (arguments.length == 3) {
      for (var i=0; i<arguments[1]-intuments[1];
...
;(function(exports) {
  ...
  // parts of pjs.
  Object.defineProperty(exports, "mo PHelper.updateMouseCoords = function(e) {
...
exports.touchY = 0;
  ...
  PHelper.setTouchPoianvases.length; n++) {
...
;(function(exports) {
  ...
  exports.constrain = function(n, l, h) { return max(min(n, h), ltop, amt) {
...
;(function(exports) {
  function PVector(x, y, z) this.x = x || 0;
    this.y = y || 0;
    this.z = z || 0;
  };
  ...
  PVector.prototype.limit = function (l) {
    var.prototype.heading = function () {
...
n = function(x) { return Math.atan(x); };
...
;(function(exports) {
  ...
  exports.quad = function(x1, y1, x2, y2, x3, y3, x4, y4) {
    ...
    PVariables.curElement.context.lineTo(x4,
    PVariables.curElement.context.lineTo(x3, y3);
...
exports.ellipseMode = function(m) {
  ...
  exports.noSmooth = function() {
    PVariables.curElement.context.mozUARE || cap == exports.PROJECT) {
  ...
  exports.strokeWeight = function(w) {
    if (typeof w === 'undefined' || w === 0)
      PVariables.curElement.context.lineWidth = 0.0001; // hack because lineWidth 0 doesn't work
	    ...
	    ;(function(exports) {
			...
			if (kind == exports.POINTS || kind == exports.LINES || kind == exports.TRIANGLES || kind == exports.TRIANGLE_FAN || kind == exports.TRIANGLE_STRIP || kind == exports.QUADS || kind =   if (mode == exports.CLOSE) {
				PVariables.curElement.context.closePath();
				PVariables.curElement.context.fill();
			    } 
			    PVariables.curElement.context.stroke();
   ...
   curxt.strokeStyle = lastS.strokeStyle; // stroke
   ...
   PVariables.rectMode = lastS.rectMode; // rectMn02, n10, n11, n12);
   ...
   m = pMultiplyMatrix(m, [n00, n01, n02, n10, n11, n12]);
				...
				PVariables.curElement.context.   m[1] = m12;
				m[2] = m21;
				m[3] = m22;
			    };
			    ...
			    exports.shearX = functi.length-1];
			m[4] += m[0] * x + m[2] * y;
			m[5] += m[1] * x + m[3] * y;
		    };
			...
			exports.textStyle = function(s) {
			    if (s == exportxt.font=PVariables.textStyle+' '+PVariables.textSize+'px '+PVariables.textFont;
				if (arguments.length == 3) {
