...
var shapevertex = function (require, core, constants) {
        ...
        p5.prototype.curveVertex = function (x, y) {
            ...
            if (curveVertices.length >= 4) {
                this.curve(curveVertices[0].x, curveVertices[0].y, curveVertices[1].x, curveVertices[1].y, curveVertices[2].x, curveVertices[2].y, curveVertices[3].x, curveVertices[3].y);
                curveVertices.shift();
            }
            return this;
        };
...
>>>>>>> abe0278afa078980752675943b061b198395e191
